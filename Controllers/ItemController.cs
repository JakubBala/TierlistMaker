...
namespace TierlistMaker.Controllers
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        {
            new ItemModel { Id = 1, Title = "CS:GO", ImageId = 1, Ranking = 0, ItemType = 1 },
            new ItemModel { Id = 2, Title = "Valorant", ImageId = 2, Ranking = 0, ItemType = 1 },
            new ItemModel { Id = 3, Title = "League of Legends", ImageId = 3, Ranking = 0, ItemType = 1 },
            new ItemModel { Id = 4, Title = "Call of Duty", ImageId = 4, Ranking = 0, ItemType = 1 },
